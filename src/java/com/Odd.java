...
public class Odd extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sess.getAttribute("hod") != null)
        {
            ...
            ResultSet rs = stmt.executeQuery("Select CourseName,CourseId,Semester from DepartmentalCourses where Semester='1' or Semester = '3' or Semester='5'  ");
            int i = 0;
            try(PrintWriter out = response.getWriter())
            {
               ...
               out.println("</form>");
                ...
                out.println("<hr>");
                out.println("<center>");
                out.println("<form action='storesubjects' method='POST'>");
                out.println("<h2>Select the Subjects to be Taught in these Odd Semesters:</h2>");
                out.println("<h3>");
                while(rs.next())
                {
                        ...
                        out.println("<input type='checkbox' name="+cid+" value="+cid+">"+ cname+"(Semester"+sem+")");
                        out.println("<br><br>");
                }
                out.println("</h3>");
